        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                <div class="flex items-center text-center justify-center mb-4">
                    <h3 class="text-3xl font-extrabold mb-2  text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-[#07074D]">Input Rawat Inap</h3>
                </div>
                <form action="/rawat-inap" method="POST">
                @csrf
                    <div class="mb-5">
                        <label for="ruang_id" class="mb-3 block text-base font-medium text-blue-700">
                            Ruang
                        </label>
                        <input type="text" name="ruang_id" id="ruang_id" placeholder="ID Ruang" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-blue-500 focus:shadow-md" />
                    </div>
                    <div class="mb-5">
            ...
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                <div class="mb-4 flex items-center justify-between">
                    <div>
                        <h3 class="text-3xl font-extrabold mb-2  text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-[#07074D]">Rawap Inap Terbaru</h3>
                    </div>
                    <div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-4 text-left whitespace-nowrap text-sm font-normal text-gray-900">
                                                <form action='/rawat-inap/{{ $key->id }}' method='post'>
                                                    @method('delete')
                                                    @csrf                                                
                                            ...
                                            <td class="p-4 text-left whitespace-nowrap text-sm font-normal text-gray-900">
                                                <form action='/rawat-inap/{{ $key->id }}/edit' >
                                                    @csrf                                                
